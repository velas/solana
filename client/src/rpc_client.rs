...
impl RpcClient {
    ...
    pub fn get_evm_transaction_count(
        ...
        self.invoke(self.rpc_client.get_evm_transaction_count(address))
    }

    pub fn get_evm_balance(&self, address: &evm_state::Address) -> ClientResult<evm_state::U256> {
        self.invoke(self.rpc_client.get_evm_balance(address))
    }
    ...
    pub fn get_evm_transaction_receipt(
        ...
        self.invoke(self.rpc_client.get_evm_transaction_receipt(hash))
    }
}
