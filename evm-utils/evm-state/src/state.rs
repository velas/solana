...
pub const BURN_GAS_PRICE: u64 = 2_000_000_000; // 2 lamports per gas (in wei).
pub const BURN_GAS_PRICE_IN_SUBCHAIN: u64 = 40_000_000_000; // 40 lamports per gas (in wei).
