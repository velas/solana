...
pub fn add_bank_snapshot<P: AsRef<Path>>(
    ...
    let evm_state_backup_path = bank_snapshots_dir.join(EVM_STATE_DIR);
...
fn rebuild_bank_from_snapshots(
    ...
    let bank = deserialize_snapshot_data_files(&snapshot_root_paths, |snapshot_streams| {
        let evm_version = match incremental_snapshot_version.unwrap_or(full_snapshot_version) {
            SnapshotVersion::V1_4_0 => EvmStateVersion::V1_4_0,
            SnapshotVersion::V1_5_0 => EvmStateVersion::V1_5_0,
        };
        Ok(bank_from_streams(
            ...
            account_secondary_indexes,
            accounts_db_caching_enabled,
            &full_snapshot_root_paths.evm_state_backup_path,
            !verify_evm_state,
            evm_archive,
            limit_load_slot_count_from_snapshot,
            shrink_ratio,
